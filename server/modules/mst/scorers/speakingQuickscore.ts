/**
 * Speaking Quickscore Engine
 * Fast heuristic scoring for speaking assessment using Whisper transcript
 */

import { SpeakingResponse, QuickscoreResult } from '../schemas/resultSchema';
import { SpeakingItem } from '../schemas/itemSchema';
...
export function validateSpeakingResponse(
  ...
  return response.asr?.text && response.asr.text.length > 0;
}