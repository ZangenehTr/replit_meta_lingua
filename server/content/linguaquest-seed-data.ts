...
export const A1_QUESTIONS: LinguaquestContentBankInsert[] = [
  {
    ...
    cefrLevel: 'A1',
    language: 'en',
    primaryText: 'How do you greet someone in the morning?',
  ...
  },
  {
    ...
    cefrLevel: 'A1',
    language: 'en',
    primaryText: 'Which word means the opposite of "big"?',
...
export const A2_QUESTIONS: LinguaquestContentBankInsert[] = [
  {
    ...
    cefrLevel: 'A2',
    language: 'en',
    primaryText: 'I _____ to Paris last summer.',
  ...
  },
  {
    ...
    cefrLevel: 'A2',
    language: 'en',
    primaryText: 'Which word is a synonym of "happy"?',
