/**
 * Client-Side Writing Quickscore Engine
 * Fast heuristic scoring for writing assessment
 * Adapted from server/modules/mst/scorers/writingQuickscore.ts
 */

import { WritingResponse, WritingItem, QuickscoreResult } from './types';
