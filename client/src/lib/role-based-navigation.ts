...
export const getStudentNavigation = (t: any): NavigationItem[] => [
  ...
  { path: "/wallet", icon: "CreditCard", label: "Wallet / Credits", roles: ["Student"] },
  { path: "/referrals", icon: "Share2", label: "Referral System", roles: ["Student"] },
];

// Teacher/Tutor navigation
export const getTeacherNavigation = (t: any): NavigationItem[] => [
  { path: "/dashboard", icon: "Home", label: "Dashboard", roles: ["Teacher/Tutor"] },
  { path: "/teacher/classes", icon: "Users", label: "Classes", roles: ["Teacher/Tutor"] },
  { path: "/teacher/schedule", icon: "Calendar", label: "Class Scheduling", roles: ["Teacher/Tutor"] },
  { path: "/teacher/assignments", icon: "ClipboardCheck", label: "Assignments", roles: ["Teacher/Tutor"] },
  ...
  { path: "/teacher/payments", icon: "DollarSign", label: "Payments", roles: ["Teacher/Tutor"] },
];
...
export const getMentorNavigation = (t: any): NavigationItem[] => [
  { path: "/dashboard", icon: "Home", label: "Dashboard", roles: ["Mentor"] },
  { path: "/mentor/students", icon: "Users", label: "Mentees", roles: ["Mentor"] },
  { path: "/mentor/sessions", icon: "Calendar", label: "Mentoring Sessions", roles: ["Mentor"] },
  { path: "/mentor/progress", icon: "TrendingUp", label: "Progress Tracking", roles: ["Mentor"] },
];
  ...
  switch (role) {
    ...
    case "Supervisor":
      return [
        ...
        { path: "/dashboard", icon: "Home", label: "Dashboard", roles: ["Supervisor"] },
        ...getInstituteManagementNavigation(t),
        ...getCallCenterNavigation(t)
      ];
    case "Call Center Agent":
      return [
        ...
        { path: "/dashboard", icon: "Home", label: "Dashboard", roles: ["Call Center Agent"] },
        ...getCallCenterNavigation(t)
      ];
    case "Accountant":
      return [
        // Dashboard - Primary navigation item for Accountant (unified dashboard)
        { path: "/dashboard", icon: "Home", label: "Dashboard", roles: ["Accountant"] },
