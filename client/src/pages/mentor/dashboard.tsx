    ...
    <AppLayout>
      <div className={`p-6 space-y-6 ${isRTL ? 'rtl' : 'ltr'}`}>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 rounded-xl p-6 md:p-8 text-white shadow-xl"
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-center md:text-left">
              <h1 className="text-2xl md:text-3xl font-bold mb-2">
                {t('mentor:welcome', 'Welcome')}, {user?.firstName || t('mentor:mentor', 'Mentor')}! 🌟
              </h1>
              <p className="text-sm md:text-base opacity-90">
                {t('mentor:welcomeMessage', 'Guide, inspire, and support your mentees on their learning journey!')}
              </p>
            </div>
            <div className="flex gap-3">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2 text-center">
                <p className="text-xs opacity-90">{t('mentor:activeMentees', 'Active Mentees')}</p>
                <p className="text-xl font-bold">👥 {mentorStats?.activeMentees || 0}</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2 text-center">
                <p className="text-xs opacity-90">{t('mentor:rating', 'Rating')}</p>
                <p className="text-xl font-bold">⭐ {mentorStats?.averageRating || 5.0}</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-gradient-to-r from-orange-500 to-orange-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-orange-100">{t('dashboard.totalMentees', { ns: 'common' })}</p>
          ...
          <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-green-100">{t('dashboard.activeMentees', { ns: 'common' })}</p>
          ...
          <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100">{t('dashboard.sessionsCompleted', { ns: 'common' })}</p>
          ...
          <Card className="bg-gradient-to-r from-purple-500 to-purple-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-100">{t('dashboard.averageRating', { ns: 'common' })}</p>
