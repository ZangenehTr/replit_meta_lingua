...
export default function TakeTestPage() {
  ...
  if (testStep === 'intro') {
    ...
    return (
      <div dir="ltr" style={{ direction: 'ltr' }} className="take-test-ltr min-h-screen bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex items-center justify-center px-4 py-12 relative overflow-hidden">
  ...
  if (testStep === 'testing' && currentQuestion) {
    ...
    return (
      <div dir="ltr" style={{ direction: 'ltr' }} className="take-test-ltr min-h-screen bg-gradient-to-br from-indigo-50 via-white to-violet-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8 px-4">
  ...
  if (showContactModal && testResults) {
    return (
      <Dialog open={showContactModal} onOpenChange={setShowContactModal}>
        <DialogContent dir="ltr" style={{ direction: 'ltr' }} className="take-test-ltr max-w-[95vw] sm:max-w-md max-h-[90vh] overflow-y-auto">
          <DialogHeader>
  ...
  if (testStep === 'roadmap' && isGeneratingRoadmap) {
    return (
      <div dir="ltr" style={{ direction: 'ltr' }} className="take-test-ltr min-h-screen bg-gradient-to-br from-indigo-50 via-white to-violet-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center px-4">
  ...
  if (testStep === 'results' && testResults) {
    return (
      <div dir="ltr" style={{ direction: 'ltr' }} className="take-test-ltr min-h-screen bg-gradient-to-br from-indigo-50 via-white to-violet-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-12 px-4">
