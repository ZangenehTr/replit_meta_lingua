...
export default function AIPracticePage() {
  ...
  return (
    <AppLayout>
      <div className="w-full space-y-4 sm:space-y-6 px-3 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4 md:py-6">
        {/* Header */}
                ...
                <div className="space-y-2 sm:space-y-3 h-48 xs:h-64 sm:h-80 overflow-y-auto">
                  {conversation.length === 0 ? (
                    <div className="text-center text-gray-500 py-8">
                      ...
                      <p className="text-xs sm:text-sm">Start your conversation by typing a message or recording audio</p>
                    </div>
                  ) : (
                        ...
                        >
                          <div className="flex-shrink-0">
                            {msg.role === 'user' ? (
                              ...
                              <Bot className="h-5 sm:h-6 w-5 sm:w-6 text-green-600" />
                            )}
                          </div>
                          <div
          ...
          <TabsContent value="settings" className="space-y-3 sm:space-y-4">
            <Card>
              ...
              <CardContent className="space-y-3 sm:space-y-4 p-3 sm:p-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs sm:text-sm font-medium">Conversation Topic</label>
                  <Select
